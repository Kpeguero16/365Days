...
- Generator tests: `node --test tests/generate-manifest.test.js` (34 tests, fixtures only; they never read or write the real `content.json` or `assets/`).
